...
% temp1 = zeros(size(x,2)^2,1);
% temp2 = zeros(size(x,2)^2,1);
% 
% for i = 1:n
%     x1i = repmat(data1(:,i),1,size(x,2));
%     x2i = repmat(data2(:,i),1,size(x,2));
%     temp1 = temp1 + 1/hn*phi((x-x1i)/hn);
%     temp2 = temp2 + 1/hn*phi((x-x2i)/hn);
% end
